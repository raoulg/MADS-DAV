...
- de oude 7.1–7.6 (streamlit: selectbox, session_state, multiselect/radio, if-elif-else, columns, model in session_state) zijn allemaal nog gedekt, maar alleen in `dashboards/` en de README daar — ⚠️ er is geen notebook dat streamlit stap voor stap doorloopt; 07.1 verwijst ernaar in 7.1.6. De 07.2-plek is nu netwerkanalyse; beslissen of de dashboards als zelfstudie volstaan of dat streamlit een eigen notebook krijgt.
- ⚠️ te beslissen: of netwerkanalyse een zesde beoordeelde visualisatie wordt. 07.2 en 07.3 leveren er materiaal voor, maar de eerlijke uitkomst op de showcase is een nulresultaat, en de rubric moet dan expliciet belonen dat een student dat durft op te schrijven in plaats van een netwerkplaatje in te leveren.
